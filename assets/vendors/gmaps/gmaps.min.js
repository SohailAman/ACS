    ...
    var t = function(e, t) {
        ...
        o = function(e, t) {
            ...
            if (Array.prototype.map && e.map === Array.prototype.map) r = Array.prototype.map.call(e, function(e) {
                ...
                for (o = 0; o < i; o++) callback_params = n, callback_params.splice(0, 0, e[o]), r.push(t.apply(this, callback_params));
            return r
        },
        n = function(e) {
            var t, o = [];
    ...
    return p.prototype.getRoutes = function(e) {
        ...
        if (s)
            for (d = 0; d < s.length; d++) {
                ...
                for (_ = 0; _ < s[d].stylers.length; _++)
                    for (var f in s[d].stylers[_]) {
        ...
        if (a) {
            ...
            var L = o.path;
            if (L.join)
                for (var b, _ = 0; b = L[_]; _++) a.push(b.join(","));
            else a.push("enc:" + L);
